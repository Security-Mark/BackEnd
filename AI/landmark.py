...
# 데이터 파일과 이미지 파일 경로
predictor_file = '/Users/sonjeongmin/ImageBackEnd/BackEnd/AI/shape_predictor_68_face_landmarks.dat'  # 자신의 개발 환경에 맞게 변경할 것
image_file = '/Users/sonjeongmin/ImageBackEnd/BackEnd/image.jpg'  # 자신의 개발 환경에 맞게 변경할 것
...
# 저장할 이미지 파일 경로
output_file = 'image1.png'  # 저장할 파일 이름
